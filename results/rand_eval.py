'''
This file compares each algorithm to their randomized variant
'''
...
method_one_list = {'merick':['deepsynergy','dtf','prodeepsyn','dscp','fuse'],
                   'merick_lodo':['deepsynergy','dtf','prodeepsyn','dscp','fuse'],
                   'merick_loclo':['deepsynergy','dtf','prodeepsyn','dscp','fuse'],
                   'almanac':['deepsynergy','dtf','prodeepsyn','dscp','fuse'],
                   'drugcomb':['deepsynergy','dtf']}[dataset]
method_two_list = {'merick':['deepsynergyrand','dtfperm','prodeepsynperm','dscpperm','fuseperm'],
                   'merick_lodo':['deepsynergyrand','dtfperm','prodeepsynperm','dscpperm','fuseperm'],
                   'merick_loclo':['deepsynergyrand','dtfperm','prodeepsynperm','dscpperm','fuseperm'],
                   'almanac':['deepsynergyrand','dtfperm','prodeepsynperm','dscpperm','fuseperm'],
                   'drugcomb':['deepsynergyrand','dtfperm']}[dataset]
thresh = {'merick':30,
                   'merick_lodo':30,
                   'merick_loclo':30,
                   'almanac':10,
